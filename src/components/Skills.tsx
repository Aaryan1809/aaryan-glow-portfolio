    ...
    <section id="skills" className="section-padding bg-muted/20">
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            <CardContent className="space-y-4">
              {currentSkills.map((skill, index) => {
                ...
                return (
                  <div
                    key={skill.name}
                    className="flex items-center justify-between p-4 bg-card/50 rounded-lg border border-border/50 hover:bg-card/80 transition-all duration-300"
          ...
          {/* Future Interests */}
          <Card className="card-glow hover-glow animate-fade-in-right">
            <CardHeader>
              <CardTitle className="text-2xl text-center">
            ...
            <CardContent className="space-y-4">
              ...
              {futureInterests.map((interest, index) => {
                ...
                return (
                  <div
                    key={interest.name}
                    className="flex items-center gap-3 p-4 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20 hover:from-primary/20 hover:to-accent/20 transition-all duration-300"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
